...
namespace TextExtractor.Helpers.NUnit.Tests
{
	...
	public class ExtractorSetHistoryTests : FakesFixture
	{
		...
		public void Constructor()
		{
			...
			Assert.DoesNotThrow(() => new ExtractorSetHistory(helper.GetServicesManager(), ExecutionIdentity.CurrentUser, artifactQuery, random.Number(), random.Number(), random.Number(), random.Number(), random.Word(), random.Word()));
		}
	}
}