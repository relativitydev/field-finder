...
namespace TextExtractor.EventHandlers.Application
{
	...
	class PopulatePredefinedRegularExpression : kCura.EventHandler.PostInstallEventHandler
	{
		...
		private List<ExtractorRegullarExpression> PopulateRegExList()
		{
			...
			List<ExtractorRegullarExpression> regExList = new List<ExtractorRegullarExpression>() { emailRegEx, ssnRegEx, usPhoneNumberRegEx, ukPhoneNumberRegEx, auPhoneNumberRegEx,
